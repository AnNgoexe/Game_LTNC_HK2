...
class Threat //the game threat (the obstable) move on the screen
{
    ...
    public:
	    ...
	    void Move(int& acceleration , int type); //Moves the threat
	    ...
	    int GetSpeed(int& acceleration); //get the speed of game threat
