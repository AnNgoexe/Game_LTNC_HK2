...
bool Check_Colission_Threat(int& life, Character character, SDL_Rect* character_clip, Threat threat, SDL_Rect* threat_clip = nullptr);
...
bool Check_Receive_Award(int& score, int&life, Mix_Chunk *gCongrats, Character character, SDL_Rect* character_clip, Award award, SDL_Rect* award_clip = nullptr);
